...
export const ConnectorModal: React.FC<ConnectorModalProps> = ({ connectorId, onClose }) => {
  ...
  const handleConnectClick = () => {
    addToast({
      type: 'info',
      title: 'Setup Notice',
      description: 'Connector setup will be enabled in a later build phase.',
    });
  };
  ...
  const handleSyncClick = () => {
    addToast({
      ...
      description: `Refreshing memory vectors for ${connector.name}...`,
    });
  };
