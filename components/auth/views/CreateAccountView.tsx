    ...
    <div className="space-y-4 text-left animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="space-y-1">
        ...
        <p className="text-sm text-slate-500 font-normal leading-relaxed">
          Start building your intelligent personal workspace
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-3" noValidate>
        {/* Full Name */}
        <div className="space-y-1">
          <label htmlFor="signup-name" className="text-xs font-medium text-slate-700 block">
            Full name
          </label>
          <div className="relative">
            ...
            <input
              ...
              required
              autoFocus
              className={`w-full h-10 pl-10 pr-3.5 text-sm bg-white text-slate-900 placeholder:text-slate-400 rounded-xl border transition-all duration-150 disabled:opacity-60 disabled:bg-slate-50 focus:outline-none ${
                isNameActiveError
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              className={`w-full h-10 pl-10 pr-10 text-sm bg-white text-slate-900 placeholder:text-slate-400 rounded-xl border transition-all duration-150 disabled:opacity-60 disabled:bg-slate-50 focus:outline-none ${
          ...
          <div className="pt-1 grid grid-cols-3 gap-1">
            <div className="flex items-center gap-1.5 text-[11px] font-normal transition-colors">
              <div
                className={`h-3.5 w-3.5 rounded-full flex items-center justify-center text-[8px] shrink-0 transition-colors ${
        ...
        {/* Confirm Password */}
        <div className="space-y-1">
          <label htmlFor="signup-confirm-password" className="text-xs font-medium text-slate-700 block">
            Confirm password
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-slate-400">
        ...
        <button
          type="submit"
          disabled={isAnyLoading}
          className="w-full h-11 px-4 rounded-xl bg-slate-950 hover:bg-slate-900 active:scale-[0.99] disabled:opacity-60 disabled:cursor-not-allowed text-white font-medium text-sm shadow-xs transition-all duration-150 cursor-pointer flex items-center justify-center gap-2 group mt-2"
        >
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <button
          ...
          disabled={isAnyLoading}
          type="button"
          className="h-10 px-3 rounded-xl bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50 disabled:opacity-60 disabled:cursor-not-allowed text-slate-800 font-medium text-xs shadow-2xs transition-all duration-150 flex items-center justify-center gap-2 cursor-pointer"
        >
          {oauthLoading === 'google' ? (
