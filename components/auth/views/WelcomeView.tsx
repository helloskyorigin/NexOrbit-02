    ...
    <div className="space-y-6 text-left animate-in fade-in zoom-in-95 duration-200">
      ...
      <div className="space-y-1 text-left">
        ...
        <p className="text-sm text-slate-500 font-normal leading-relaxed">
          Sign in to continue to NexOrbit
        </p>
      </div>
      ...
      {/* Primary Flow: Email First */}
      <form onSubmit={handleEmailSubmit} className="space-y-4">
        <div className="space-y-1.5">
          <label htmlFor="email-input" className="text-xs font-medium text-slate-700 block">
            Email address
          </label>
      ...
      <div className="space-y-2.5">
        ...
        <button
          ...
          type="button"
          className="w-full h-11 px-4 rounded-xl bg-white border border-slate-200 hover:border-slate-300 hover:bg-slate-50/80 text-slate-800 font-medium text-sm shadow-2xs transition-all duration-150 flex items-center justify-center gap-3 cursor-pointer group"
        >
